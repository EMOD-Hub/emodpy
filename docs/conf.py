...
# Rename "emodpy" to "API reference"
...
latex_documents = [
    (master_doc, 'emodpy-docs.tex', u'emodpy',
...
man_pages = [
    (master_doc, 'emodpy-docs', u'emodpy',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'emodpy-docs', u'emodpy',
     author, 'Institute for Disease Modeling', 'How to use emodpy for disease simulations.',
     'Miscellaneous'),
]
