...
class TestTargetingConfig():
    ...
    def test_targeting_logic(self):
        ...
        assert (is_high_risk_AND_pregnant_OR_low_risk_AND_has_flu_vaccine_json == is_high_risk_AND_pregnant_OR_low_risk_AND_has_flu_vaccine1.to_simple_dict(self.campaign))
        assert (is_high_risk_AND_pregnant_OR_low_risk_AND_has_flu_vaccine_json == is_high_risk_AND_pregnant_OR_low_risk_AND_has_flu_vaccine2.to_simple_dict(self.campaign))
        ...
        assert (is_high_risk_OR_pregnant_AND_low_risk_OR_has_flu_vaccine_json == is_high_risk_OR_pregnant_AND_low_risk_OR_has_flu_vaccine1.to_simple_dict(self.campaign))
        assert (is_high_risk_OR_pregnant_AND_low_risk_OR_has_flu_vaccine_json == is_high_risk_OR_pregnant_AND_low_risk_OR_has_flu_vaccine2.to_simple_dict(self.campaign))
        ...
        assert (is_high_risk_or_pregnant_AND_low_risk_or_has_flu_vaccine_json == is_high_risk_or_pregnant_AND_low_risk_or_has_flu_vaccine.to_simple_dict(self.campaign))
